      ...
      <div className="card-body">
        <div className="row">
          ...
          <span className="col-2">
            {details.openNow && (
              <span className="badge rounded-pill bg-success">Open Now</span>
            )}
            {!details.openNow && (
              <span className="badge rounded-pill bg-warning">Closed Now</span>
            )}
          </span>
        </div>
        <div className="row">
        ...
        <div className="row">
          ...
          <span className="col-8">
            <ul>
              {details.weekdayText.map((dayDetail) => (
                <li key={dayDetail}>{dayDetail}</li>
              ))}
            </ul>
          </span>
        </div>
